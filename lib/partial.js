...
var isBreakpoint = function(beforeLeft, beforeRight, currentLeft, currentRight){
  if(currentLeft !== beforeLeft && currentLeft === "" && beforeRight === ""){
    return true
  }
  if(currentRight !== beforeRight && currentRight === "" && beforeLeft === ""){
    return true
  }
  return false
}
...
module.exports = function(array){
  var result = partial(array.concat().reverse(), [])
  return result
}
